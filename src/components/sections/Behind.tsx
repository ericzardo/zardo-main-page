              ...
              <div className="rounded-xl overflow-hidden">
                ...
                <div className="absolute p-4 flex items-end justify-between bottom-0 left-0 right-0 h-1/5 bg-gradient-to-t from-brand-navy/90 to-transparent">
                  ...
                  <div className="flex items-center justify-end gap-2">
                    <Link href="#" className="text-brand-offwhite transition-all duration-200 ease-out hover:scale-75 hover:text-brand-lavender"><Linkedin size={24} strokeWidth={1}/></Link>
                    <Link href="#" className="text-brand-offwhite transition-all duration-200 ease-out hover:scale-75 hover:text-brand-lavender"><Github size={24} strokeWidth={1}/></Link>
                  </div>
                </div>
              </div>
            </div>
          ...
          <SectionTransition direction="right">
            <div className="flex flex-col gap-8">
              <p className="text-brand-offwhite">
                Hi, I&lsquo;m Eric Zardo, from Porto Alegre, Brazil.
              </p>
              <p className="text-brand-offwhite">
